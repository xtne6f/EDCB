...
✏TSIDの移動があるときは[Tools/tsidmove_helper.bat](ini/Tools/tsidmove_helper.bat)で予約ファイルに含まれるTSIDの情報を更新できます。  
チャンネル情報(*.ChSet4.txtやChSet5.txt)はあらかじめチャンネルスキャンなどで更新してください。  
EpgTimer(NW).exeについてはEpgTimerの設定画面を一度起動してください。更新が必要なときは起動時にダイアログが出ます( [562f565](https://github.com/xtne6f/EDCB/commit/562f565e10c40d1de404b17f6afac2818d003bd3) )。
