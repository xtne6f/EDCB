...
template<class T> DWORD CCUTIL2_GetVectorVALUESize2_( WORD ver, const vector<T>* val );
template<class T> DWORD CCUTIL2_GetPtrVectorVALUESize2_( WORD ver, const vector<T>* val );
template<class T> BOOL CCUTIL2_WriteVectorVALUE2_( WORD ver, const vector<T>* val, BYTE* buff, DWORD buffSize, DWORD* writeSize );
...
template<class T> BOOL CCUTIL2_ReadAndNewVectorVALUE2_( WORD ver, vector<T*>* val, const BYTE* buff, DWORD buffSize, DWORD* readSize );
...
inline DWORD GetVALUESize2(WORD ver, const vector<RESERVE_DATA*>* val ){ CCUTIL2_VECTOR_GET_SIZE_; }
inline BOOL WriteVALUE2(WORD ver, const vector<RESERVE_DATA*>* val, BYTE* buff, DWORD buffSize, DWORD* writeSize ){ CCUTIL2_VECTOR_WRITE_; }
inline BOOL ReadVALUE2(WORD ver, vector<RESERVE_DATA*>* val, const BYTE* buff, DWORD buffSize, DWORD* readSize ){ CCUTIL2_VECTOR_READ_AND_NEW_; }
...
template<class T>
DWORD CCUTIL2_GetVectorVALUESize2_( WORD ver, const vector<T>* val )
{
...
template<class T>
BOOL CCUTIL2_WriteVectorVALUE2_( WORD ver, const vector<T>* val, BYTE* buff, DWORD buffSize, DWORD* writeSize )
{
...
template<class T>
BOOL CCUTIL2_ReadAndNewVectorVALUE2_( WORD ver, vector<T*>* val, const BYTE* buff, DWORD buffSize, DWORD* readSize )
{
	if( val == NULL || buff == NULL || buffSize < sizeof(DWORD)*2 ){
		return FALSE;
	}
