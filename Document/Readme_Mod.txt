...
番組情報やファイル名のUnicode対応のため、予約情報(Reserve.txtなど)の既定の文字コ
ードを変更しました。後述「予約ファイル等のByteOrderMark付きUTF-8対応について」を
参照してください。
...
※EpgTimerTaskはEpgTimerSrvに統合しました。EpgTimerSrv.exeをコピーしてリネームす
るか、EpgTimerSrv.exeに/taskオプションをつけるとEpgTimerTaskとして動作します。
...
特権が必要な機能を使わない場合や、(お勧めしませんが)EpgTimerSrv.exeをサービスと
して使用する場合は不要です。無視してください。
